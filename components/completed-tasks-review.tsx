...
export function CompletedTasksReview() {
  ...
  async function verify(taskId: number) {
    ...
    const response = await fetch("/api/completed-tasks", { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ taskId }) })
