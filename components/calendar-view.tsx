...
export function CalendarView({ tasks, sector, isManager, toggleTaskCompletion, completeTasks }: { tasks: TaskWithPromotion[]; sector: string | null; isManager: boolean; toggleTaskCompletion: (formData: FormData) => Promise<void>; completeTasks: (formData: FormData) => Promise<void> }) {
